...
Everest Insurance`,
    ...
    return (
        <div className="configuration-page page-container" style={{ overflowY: 'auto', maxHeight: 'calc(100vh - 60px)', paddingBottom: '40px', paddingLeft: '12px', paddingRight: '12px' }}>
            <h2 style={{ fontWeight: 700, color: '#2A4E86', fontSize: '1.1rem', textTransform: 'uppercase', letterSpacing: '1.5px', marginBottom: '20px', paddingLeft: '16px' }}>Admin Page</h2>

            {/* Email Templates Card */}
            <Card className="config-card" style={{ marginBottom: '24px' }}>
                <Card.Header className="d-flex justify-content-between align-items-center" style={{ background: '#2A4E86', color: 'white', fontSize: '1.2rem', fontWeight: 700, letterSpacing: '1px', textAlign: 'center', justifyContent: 'center' }}>
                    <span>Email Templates</span>
                    <div className="d-flex align-items-center gap-3">
                        <Button size="sm" variant="outline-light" onClick={handleAddTemplate} disabled={templates.length >= 10} style={{ fontWeight: 600, borderRadius: '20px', padding: '4px 14px', fontSize: '0.75rem' }}>+ New Template</Button>
                    </div>
                </Card.Header>
                    ...
                    <Table hover className="mb-0" style={{ fontSize: '0.78rem' }}>
                        <thead style={{ background: '#f8f9fa' }}>
                            <tr>
                                ...
                                <th style={{ width: '14%', padding: '12px 16px' }}>Issue Type</th>
            ...
            {/* Quick Reference */}
            <Row className="mt-4" style={{ marginBottom: '24px' }}>
                <Col md={6}>
                    <Card className="config-card">
                        <Card.Header className="d-flex justify-content-between align-items-center" style={{ background: '#2A4E86', color: 'white', fontWeight: 700, fontSize: '1rem', letterSpacing: '0.5px' }}>
                            <span>Available Variables</span>
                            <Button size="sm" variant="outline-light" onClick={handleAddVariable} style={{ fontWeight: 600, borderRadius: '20px', padding: '4px 14px', fontSize: '0.75rem' }}>+ Add</Button>
                        </Card.Header>
                ...
                <Col md={6}>
                    <Card className="config-card">
                        <Card.Header className="d-flex justify-content-between align-items-center" style={{ background: '#2A4E86', color: 'white', fontWeight: 700, fontSize: '1rem', letterSpacing: '0.5px' }}>
                            ...
                            <Button size="sm" variant="outline-light" onClick={handleAddGroup} style={{ fontWeight: 600, borderRadius: '20px', padding: '4px 14px', fontSize: '0.75rem' }}>+ Add</Button>
                        </Card.Header>
                        <Card.Body style={{ padding: '0' }}>
                            <Table size="sm" className="mb-0" style={{ fontSize: '0.85rem' }}>
                                <thead style={{ background: '#f8f9fa' }}>
            ...
            <Modal show={showEditModal} onHide={() => setShowEditModal(false)} size="lg">
                <Modal.Header closeButton style={{ background: '#2A4E86', color: 'white' }}>
                ...
                <Modal.Body>
                    {editingTemplate && (
                        <>
                            ...
                            <Form.Group className="mb-3">
                                <Form.Label><strong>Issue Type</strong></Form.Label>
                                <Form.Select 
                ...
                <Modal.Footer>
                    ...
                    <Button variant="primary" size="sm" style={{ background: '#2A4E86', border: 'none' }} onClick={handleSave}>
                        Save Changes
                    </Button>
                </Modal.Footer>
            </Modal>
            ...
            <Modal show={showGroupModal} onHide={() => setShowGroupModal(false)}>
                ...
                <Modal.Footer>
                    ...
                    <Button 
                        variant="primary" 
                        size="sm" 
                        style={{ background: '#2A4E86', border: 'none' }} 
